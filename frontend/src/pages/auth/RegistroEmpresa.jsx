...
const camposIniciales = {
    username: '', clave: '', nombre: '', localizacion: '',
...
export default function RegistroEmpresa() {
    ...
    const handleSubmit = async e => {
        ...
        setError(null);
        try {
            const res = await apiFetch('/api/auth/registro/empresa', {
                method: 'POST',
            ...
            <div style={styles.card}>
                ...
                <form onSubmit={handleSubmit} style={styles.form}>
                    {[
                        ...
                        { name: 'nombre', label: 'Nombre de la empresa', type: 'text', placeholder: 'Ej: TechCR SA' },
                        { name: 'localizacion', label: 'Localización', type: 'text', placeholder: 'Ej: San José' },
                        { name: 'correo', label: 'Correo electrónico', type: 'email', placeholder: 'info@empresa.com' },
